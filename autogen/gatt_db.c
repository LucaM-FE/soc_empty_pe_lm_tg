...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_34) = {
  .len = 16,
  .data = { 0xf5, 0x60, 0x04, 0x8e, 0x71, 0x8b, 0x23, 0xb5, 0x97, 0x4f, 0x9e, 0x17, 0x0e, 0x2f, 0x01, 0x86, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 15,
  .data = { 0x50, 0x45, 0x5f, 0x4c, 0x4d, 0x5f, 0x54, 0x47, 0x5f, 0x50, 0x52, 0x4f, 0x4a, 0x5f, 0x31, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x25, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x08, .char_uuid = 0x8000 } },
  { .handle = 0x26, .uuid = 0x8000, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
